...
I bought into the excuses above, for _most_ of my career.  And some of them were even
...
I fell into a trap, and this is a trap that _many_ new, occasional, and hobbyist
...
to be.  Basic traversal, manipulation, and creation of elements is straightforward
...
In fact, this is completely unnecessary with the existence of `forEach` and `Object.keys()`
